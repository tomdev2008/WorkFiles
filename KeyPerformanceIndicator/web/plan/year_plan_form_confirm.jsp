...
<!--
	...
	function ev_edit(indicatorId,assId){
		var url = "${ROOT}/editYearPlanIndicatorByDlg.do?srcHandlerId=${srcHandlerId}&flowCode=${flowCode}&id=${assessment.id}&isUndo=${isUndo}&indicatorId="+indicatorId+"&confirm=yes";
...
<body class="LN_body">
<form name="form1" method="post" action="${ROOT }/saveYearPlanIndicator.do">
