...
<html>
	<head>
		...
		<script>				
			var context = "${ROOT}";
			//专业线/通用岗位列表
			function list_indiType(id){
				var targetTypeID = "0"
				if(id != 'root') {
					targetTypeID = id;
				}else{
					targetTypeID = "<%=com.shengdai.kpi.system.Globals.ROOT_ID%>";
				}
				parent.parent.fbody.fbody.location.href='${ROOT}/listInfoIndicatorType.do?parentId='+targetTypeID+'&type=${type}';
			}
		</script>
