...
<body >
	<div class="kpi">
		<div id="divTree" class="sidebar">
			<h3>组织架构</h3>
			<iframe id="ftree"  src="${ROOT}/treeOrg.do?jsFunc=list_template" scrolling="auto" frameborder="0" name="ftree" width="100%" height="100%"></iframe>
		</div>
		<div id="divList" class="content2">
			<iframe src="${ROOT}/listTemplate.do?orgId=root" id="fbody" scrolling="no" frameborder="0" name="fbody" width="100%" height="100%" onload="autoResize(this)" ></iframe>
		</div>
