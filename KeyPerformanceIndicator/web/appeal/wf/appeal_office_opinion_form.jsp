...
<div class="LN_Append">
	 ...
	 <div class="LN_popupsRef100"><a href="#" onclick="AA_Show('${appeal.assessmentId}');return false;">查看考核表</a></div>
</div>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox">
	   ...
	   <br/>
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
		    ...
		    <c:if test="${appealResult.id!=o.id}">
			    <tr>
			        ...
			        <td align="left" valign="bottom" class="LN_tableBoxText">
			        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
			        		<tr align="left" valign="bottom">
			        			...
			        			<td><p align="left">处理人签名：${o.realHandlerName}&nbsp;&nbsp;&nbsp;&nbsp;</p>
			          			<p align="left">
