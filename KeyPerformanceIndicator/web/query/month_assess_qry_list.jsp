...
<head>
	...
	function showAssessment()
    	{
    	    openFullScreenWin("${ROOT}/web/query/month_assess_qry.jsp");
...
<div class="LN_formTitle">员工月度考核成绩查询</div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="LN_infbox-border">
  ...
  <tr>
    ...
    <table onclick="showAssessment()" width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
      <tr>
      ...
      <tr>
        ...
        <td class="LN_tableBoxText2">2010年1月份</td>
        </tr>
      <tr>
