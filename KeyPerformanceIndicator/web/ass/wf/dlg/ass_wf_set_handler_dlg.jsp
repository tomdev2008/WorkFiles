...
<script type="text/javascript">
	...
	function ev_submit(){
		...
		if(CheckForm(form)){
					new Ajax.Request("${ROOT}/saveIndicatorNodeHandlerByOrg.do", {
...
//			parentWin.document.getElementById("handlerName").value = $_EV("handlerText");
	...
	function FF_RefHandler(control,index){
		...
		var returnValue = window.showModalDialog("${ROOT}/showAssIndicatorPreviousNodeHandler.do?id=${param.id}&nodeId=${currentNode.id}"
...
<body  class="LN_body">
<form name="form1" method="post" action="" target="DialogWin">
