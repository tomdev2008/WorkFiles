...
<!--
	function ev_showAssessment(wid,assID,userId,isUndo){
		...
		var url = "${ROOT}/editAssessmentAllByUser.do";
		url = url+params;
    ...
    <td class="LN_press">
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
            ...
            <c:forEach var="o" items="${assessmentList}" varStatus="idx">
	            ...
	            &nbsp;</td>
	            <td class="LN_tableBoxText2">
	            	<ass-page:assGradeMapping selectedId="${o.assGrade!=null?o.assGrade:o.assGradeValue}"
	            	attrExtends="${isGradeNode && boInfoM[o.id].status==1?'':\"disabled='true'\"}"/></td>
	            </tr>
            </c:forEach>
          </table>
      </td>
