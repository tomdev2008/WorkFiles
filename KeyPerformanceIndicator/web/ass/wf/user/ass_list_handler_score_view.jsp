...
<!--
	function ev_showAssessment(wid, assID,userId,isUndo){
		...
		var url = "";
		if(editView=='1'){
			url = "${ROOT}/editAssessmentPlanByUser.do";
		}else if(editView=='2'){
			url = "${ROOT}/editAssessmentNodeGradeByUser.do";
		}else if(editView=='3'){
			url = "${ROOT}/editAssessmentNotNodeGradeByUser.do";
		}else if(editView=='4'){
			url = "${ROOT}/editAssessmentScoreGradeByUser.do";
		}else if(editView=='5'){
			url = "${ROOT}/editAssessmentNodeGradeInheritByUser.do";
		}else if(editView=='7'){
			url = "${ROOT}/editAssessmentAllByUser.do";
		}else if(editView=='8'){
			url = "${ROOT}/editAssessmentCollectByUser.do";
		}
		url = url+params;
    ...
    <td class="LN_press">
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
            ...
            <c:forEach var="o" items="${assessmentList}" varStatus="idx">
	            ...
	            <td class="LN_tableBoxText2">
	            	<fmt:formatNumber value="${o.handlerSumScore}" pattern="##0.0#"/>
	            &nbsp;</td>
	            </tr>
            </c:forEach>
          </table>
