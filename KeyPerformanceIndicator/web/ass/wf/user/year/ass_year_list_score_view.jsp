  ...
  <tr>
    <td class="LN_press">
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
            ...
            <td width="10%" class="LN_tableBoxtitle2">考核评分</td>
            </tr>
            <c:forEach var="o" items="${assessmentList}" varStatus="idx">
	            ...
	            <td class="LN_tableBoxText2">
					<c:forEach var="o1" items="${o.assNodeGradeHandlerSums}">
					<c:choose>
						<c:when test="${boInfoM[o.id].srcHandlerId==o1.handlerId}">
							${o1.score }
						</c:when>
					</c:choose>
					</c:forEach>
				</td>
				<c:if test="${fn:length(o.assNodeGradeHandlerSums)<1}"><td class="LN_tableBoxText2">
