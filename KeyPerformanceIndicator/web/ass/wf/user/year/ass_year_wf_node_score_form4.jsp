...
<!--
	...
	function ev_showMonthScore(gradeId,assId,ownerId,isUndo){
		var url = "${ROOT}/editAvgMonthScore.do?gradeId="+gradeId+"&assId="+assId+"&ownerId="+ownerId+"&isUndo="+isUndo+"&batchId=${assessment.batchId}";
...
<body class="LN_body">
<form name="form1" method="post" action="${ROOT }/saveYearAssessmentGradeScore.do">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2" id="configIndiTable">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox">
        <tr>
          ...
          <td  width="10%" align="right" class="LN_tableBoxText22">
          	<strong>月度考核平均分:</strong>
          	<a href="#" title="查看月度考核成绩" onclick="ev_showMonthScore('${assessmentYearGradeScore.id}','${assessmentYearGradeScore.assessment.id}','${assessmentYearGradeScore.assessment.ownerId}','false')">
          	<font color="blue">
          ...
          <fmt:formatNumber pattern="##0.0#" value="${assessment.secondScore}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <fmt:formatNumber var="formatScore" value="${assessment.assScore}" pattern="##0.0#"/>
				...
				<c:if test="${currentNode!=null && isUndo}"><c:set var="disabled" value=""/></c:if>
