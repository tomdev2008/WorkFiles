  ...
  <tr>
    <td class="LN_press">
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
            ...
            <td width="10%" class="LN_tableBoxtitle2">员工互评</td>
            <td width="10%" class="LN_tableBoxtitle2">部门经理评分</td>
            </tr>
            <c:forEach var="o" items="${assessmentList}" varStatus="idx">
	            ...
	            <td class="LN_tableBoxText2">
					<c:forEach var="o1" items="${o.assNodeGradeHandlerSums}" varStatus="idx1">

						<c:if test="${o1.nodeId!=currentNode.id}">
							评分${idx1.count }：${o1.score }<br/>
						</c:if>
