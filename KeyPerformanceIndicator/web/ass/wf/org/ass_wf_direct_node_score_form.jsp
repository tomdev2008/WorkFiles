  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2" id="configIndiTable">
	            	...
	            	<tr>
	            		...
	            		<c:choose>
	            			...
	            			<c:when test="${o2.showExtType==2}">
	            				...
	            				<a href="javascript:void(0);" class="LN_BlueLink" onclick="ev_edit('${o1.id }','${assessment.id}','${assessment.id}');return false;">
						...
						<!-- 放置环节信息 -->	
			          		<c:if test="${currentNode!=null}"> 
					          		...
					          		<input type="text" name="score" id="score${currentNode.id}${idx1.count}${idx.count}" onblur="ev_cal();"
		...
		<c:if test="${currentNode!=null}"> 
				          	...
				          	colspan="${fn:length(assessment.assIndicatorUseAttributes)}">
				            <strong>评分汇总：</strong>
