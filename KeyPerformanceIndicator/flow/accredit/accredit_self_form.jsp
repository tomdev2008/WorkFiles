...
function ev_save()
{
	...
	if (method=="update")
	{
		formFrame.accreditForm.action="/updateSelfAccredit.do";
	}
	if (method=="add")
	{
		formFrame.accreditForm.action="/createSelfAccredit.do";
	}
...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr><td>
   <iframe scrolling="auto"   src="/viewSelfAccredit.do?method=<%=request.getParameter("method")%>&accreditID=<%=request.getParameter("accreditID")%>"
