									...
									<TBODY>
										<TR>
											...
											<TD width="72%" height=25>
												<INPUT  class=editline size=30 value="<bean:write name="flwRoute" property="routeFlag"/>" name="routeFlag" check="notBlank" showName="路由名称" required="true" maxlength="128"/>
											</TD>
										</TR>
										<TR>
											<td align="right"></td>
										...
										<TR>
											...
											<TD height=25>
												<INPUT class=editline size=30 value="默认上一环节分;挂靠部门得分;" name=flowName>
												<input type='button' name='add_attach_button' onclick='javascript:routeExt();' value='选择' class="button">
											</TD>
										</TR>
										<TR>
											<td align="right"></td>
											<td colspan="2">
												<font color="red">扩展程序显示的是扩展程序名，可以多个，中间用分号分隔</font>
											</td>
										</tr>
										<TR>
											<td align="right"></td>
