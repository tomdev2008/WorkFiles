...
%>
listFrame.location.href = "${ROOT}/listWorklistForRecBatch.do?monitorId=<%=request.getParameter("id")%>&id=<%=request.getParameter("recBatchId")%>";
<%
}
%>
}
...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr>
	 	<td width="100%">
		<IFRAME name=listFrame src="${ROOT}/watchMonitor.do?id=<%=request.getParameter("id")%>" width="100%" height="100%"></IFRAME>
 	</td></tr>
</table>
