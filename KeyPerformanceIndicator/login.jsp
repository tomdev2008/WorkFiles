...
<input type="hidden" name="Url" value="${Url}"><%-- 页面可能是用户超时造成的，重新登录后要返回原请求页面 --%>
...
<div class="LN_LoginBox">
  <div class="LN_LoginBg">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="image" name="imageField" id="imageField" src="${ROOT}/images/login_button.gif" /></td>
      </tr>
    </table>
    </div>
  </div>
</div>
<div class="LN_LoginCopyRight">${WEB_TITLE }</div>
</form>
</body>
</html>
