...
<div class="easyui-layout" fit="true">
  ...
  <div region="south"  style="height:200px;overflow: hidden;" split="true" border="false">
	<div class="easyui-panel" title="产品信息" style="padding:1px;" fit="true" border="false" id="tbContractListpanel">
...
<script type="text/javascript">
 ...
 {
	 $('#tbContractListpanel').panel("refresh", "tbContractController.do?contractDetail&id="+rowData.id);
 }
 /*
 $(function() {
