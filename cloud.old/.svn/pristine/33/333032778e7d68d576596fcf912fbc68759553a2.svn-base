...
a:hover {
 ...
 <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
  <!-- 顶部-->
  <div region="north" border="false" title="UNICOM V1.0 公告系统" style="BACKGROUND:#E6E6FA;height: 85px; padding: 1px; overflow: hidden;">
  ...
  <div region="south" border="false" style="height: 25px; overflow: hidden;">
    ...
    &copy; 版权所有
     <span class="tip">Copyright© 1999-2013     中国联通   版权所有</span>
   </div>
  </div>
