...
Ext.apply(Ext.form.VTypes, {
    ...
    numAndyText: 'Must be figures,And no more than 32767'
});
...
Ext.apply(Ext.form.VTypes, {
    ...
    numText: 'Please enter the right mobilephone number'
});
...
Ext.apply(Ext.form.VTypes, {
    ...
    numAgeText: 'Please enter the right mobilephone number!'
});
...
Ext.apply(Ext.form.VTypes, {
    ...
    numwText: 'Only input digital and value < 999999.99'
});
...
Ext.apply(Ext.form.VTypes, {
    ...
    numDayMaxText: 'Must be figures,And no more than 100W'
});