...
public class CommonUtil {
	 ...
	 * 
	 * @param num
	 * @param type 0:整数 1:一位小数 2:两位小数 3:三位小数如此类推
	 * @param change 是否转换
	 * @return
	 * @author zhangjh 新增日期：2013-10-16
	 * @since private-kx-system
	 */
	public String numberFormat(String num,int type,boolean change){
		if(!change)
			return num;
	...
	public static String quChuHuanHang(String str){
		String dest = "";
