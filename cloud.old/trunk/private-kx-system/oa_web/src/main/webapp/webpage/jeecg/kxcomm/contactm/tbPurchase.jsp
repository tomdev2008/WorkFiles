  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tbPurchaseController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<select id="tbPurchaseContract.contractNo"  name="tbPurchaseContract.contractNo"   datatype="*">
							<option value="null">无</option>
					       <c:forEach items="${contractList}" var="temp">
					        <option value="${temp.contractNo }" <c:if test="${temp.contractNo==tbPurchasePage.tbPurchaseContract.contractNo}">selected="selected"</c:if>>
					         ${temp.contractNo}
					        </option>
					       </c:forEach>
				      	</select>
				...
				<td align="right">
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker()"  style="width: 150px" id="placeOrderDate" name="placeOrderDate" ignore="ignore"
							     value="<fmt:formatDate value='${tbPurchasePage.placeOrderDate}' type="date" pattern="yyyy-MM-dd"/>">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker()"  style="width: 150px" id="paymentDate" name="paymentDate" ignore="ignore"
							     value="<fmt:formatDate value='${tbPurchasePage.paymentDate}' type="date" pattern="yyyy-MM-dd"/>">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
