...
<script type="text/javascript" src="webpage/jeecg/kxcomm/contactm/standardConfiguration_controller.js"></script>
<script type="text/javascript" src="webpage/jeecg/kxcomm/contactm/standardConfiguration_view.js"></script>
<script>
...
<body class="easyui-layout">
   ...
   <t:dgCol title="目录单价" field="catalogPrice" ></t:dgCol>
   <t:dgCol title="折扣后价格" field="discountedAfterPrice" ></t:dgCol>
