...
<script type="text/javascript" charset="utf-8">
	 ...
	 */
	function exportXls() {
		 window.location.href="courseController.do?exportXls";
	}
</script>
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
  <t:datagrid name="courseList" title="课程" actionUrl="courseController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="false"></t:dgCol>
   <t:dgCol title="课程名称" field="name" ></t:dgCol>
   <t:dgCol title="老师姓名" field="teacher_name" ></t:dgCol>
   ...
   <t:dgToolBar title="导出Excel" icon="icon-search" onclick="exportXls();" ></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>