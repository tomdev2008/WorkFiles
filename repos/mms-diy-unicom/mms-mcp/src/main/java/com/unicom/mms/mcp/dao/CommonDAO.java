package com.unicom.mms.mcp.dao;
...
import com.unicom.mms.mcp.common.Page;
import com.unicom.mms.mcp.common.ReflectionUtils;
			...
			return (Page<T>) getHibernateTemplate().execute(  
					new HibernateCallback() {  
						...
						throws HibernateException, SQLException {  
							...
							pageList.setTotalCount(findTotalCount(counthql, values));
