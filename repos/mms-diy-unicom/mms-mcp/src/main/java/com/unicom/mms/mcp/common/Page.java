...
public class Page<T> implements Serializable {
	...
	public Page(HttpServletRequest request) {
		String start2 = request.getParameter("start");// 当前页第丄1�7条数据的行数
	...
	/**
	 * 获取任一页第丄1�7条数据在整个结果中的位置（每页数据容量使用默认）
	 * 
	 * @param pageNo
	 *            页码，从1弄1�7姄1�7
	 * @return 位置序号（从0弄1�7始）
	...
	/**
	 * 获取任一页第丄1�7条数据在整个结果中的位置（每页数据容量使用指定）
	 * 
	 * @param pageNo
	 *            页码，从1弄1�7姄1�7
	 * @param pageSize
