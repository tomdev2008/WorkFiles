...
*/
public class SendedRecsDAO extends CommonDAO<TbSendedMmsRecs>{
	private static Logger log = Logger.getLogger(SendedRecsDAO.class);
	
	  public List<TbSendedMmsRecs> queryByPage (int pageSize, int pageNow,String sponsor) {
