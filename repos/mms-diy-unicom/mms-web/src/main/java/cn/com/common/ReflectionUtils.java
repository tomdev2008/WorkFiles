 ...
 *  反射工具籄1�7.
 * 
 * 提供访问私有变量,获取泛型类型Class, 提取集合中元素的属�1�7�1�7, 转换字符串到对象等Util函数.
 * 
 * @author chenliang
 *
 */
public class ReflectionUtils {
	...
	/**
	 * 
	 * 把对象里String属�1�7�为空字符串的设置为null
	 * @author chenliang 新增日期＄1�712-7-29
	 * @param object 霄1�7要设置的对象
	 */
	 ...
	 * @author chenliang 新增日期＄1�712-7-29
	 * @param object 霄1�7要设置的对象
	 * @param excludePropertys 不设置为空的属�1�7�1�7
	 */
