...
public class BlankUtil {
	...
	/**
	 * 
	 * 方法用�1�7�和描述: 判断Serializable是否为空
	 * 
	 * @param obj
	 * @return 为空返回true
	 * @author dengcd 新增日期＄1�708-10-9
	...
	/**
	 * 
	* 方法用�1�7�和描述: 将double型数据转换成保留小数点后两位
	* @param num
	* @param precision
	* @return
	* @author chenhui 新增日期＄1�710-12-23
	* @author 你的姓名 修改日期＄1�710-12-23
	* @since zte_crbt_bi
	 */
	...
	/**
	 * 
	 * 方法用�1�7�和描述:给数字型数据加千位分隔符
	 * 
	 * @return
	 * @throws Exception
	 * @author 李智构1�7 新增日期＄1�712-03-03
	 * @author 你的姓名 修改日期＄1�7
	 * @throws SQLException 
	 * @since smg_bi
	 */
