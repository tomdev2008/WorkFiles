Ext.onReady(function() {
	...
	var topTool = Ext.create("Ext.toolbar.Toolbar",{
		items:[
			"手机号码：",
			{xtype:"textfield",fieldLabel:"",id:'phone',width:200,maxLength:20},
			"-",
			"开通时间：",
			{xtype:"textfield",fieldLabel:"",id:'startTime',width:200,maxLength:20},
			"-",
			"退订时间：",
			{xtype:"textfield",fieldLabel:"",id:'endTime',width:200,maxLength:20},
			"-",
			{
				xtype:'button',
				text:"查询",
	...
	var griduser=Ext.create('Ext.grid.Panel', {
		...
		columns: [
		          ...
		          { header: '开通时间',  dataIndex: 'startTime' ,flex:1},
		          { header: '退订时间', dataIndex: 'endTime', flex:1}
		          ],
