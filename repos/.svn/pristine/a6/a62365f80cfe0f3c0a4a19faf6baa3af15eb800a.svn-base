...
//	}
	...
	* @since mms-mcp-new
	...
	public String groupManage(@WebParam(name="param")String param,
		...
		try {
			...
			this.serviceLogService.saveServiceLog(ts);
		}
	...
	* @since mms-mcp
	 */
	@WebMethod
	public String sendPostcardMms(@WebParam(name="param")PostcardMMS msg){
		Response res = new Response();
		TbServices ts = new TbServices();
		try {
	 ...
	 */
	@WebMethod
	public String sendBatchMms(@WebParam(name="param")BatchSendMMS msg,
			@WebParam(name="channel")String channel,
			@WebParam(name="userMdn")String userMdn){
		Response res = new Response();
		TbServices ts = new TbServices();
	 ...
	 */
	@WebMethod
	public String sendBatchSms(@WebParam(name="param")BatchSendSMS msg){
		Response res = new Response();
		TbServices ts = new TbServices();
		try {
			//TODO 请在重新定义接口的入参和返回结果
	 ...
	 */
	@WebMethod
	public String sendRealtimeSms(@WebParam(name="param")RealTimeSMS msg){
		Response res = new Response();
		TbServices ts = new TbServices();
		try {
			//TODO 请在重新定义接口的入参和返回结果
