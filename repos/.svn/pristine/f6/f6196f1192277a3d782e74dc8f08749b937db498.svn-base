...
//提交后台，发送明信片
function sendCard(){
	var addresseeIds = $("#addressee").val(); //收件人
	var bgMusic = $("#themuzics").val(); //背景音乐
...
<!-- 						<span class="yp1 png"></span> -->
				...
				<span class="lbox-btns">
					<button id="zuomieye" class="btns-next" title="下一步" onClick="closOneOpenTwo();" type="button"></button>
