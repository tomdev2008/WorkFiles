...
public class TagUtil {
	 ...
	 * @param list
	 */
	private static String listtojson(String[] fields, int total, List list) throws Exception {
		Object[] values = new Object[fields.length];
	...
	private static JSONObject getJson(DataGrid dg) {
		...
		try {
			jObject = JSONObject.fromObject(listtojson(dg.getField().split(","), dg.getTotal(), dg.getReaults()));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jObject;
