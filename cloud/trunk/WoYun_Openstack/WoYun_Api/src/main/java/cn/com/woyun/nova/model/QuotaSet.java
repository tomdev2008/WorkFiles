...
public class QuotaSet {
	...
	public String toString() {
		return "QuotaSet [id=" + id + ", metadataItems=" + metadataItems
				+ ", injectedFileContentBytes=" + injectedFileContentBytes
				+ ", injectedFiles=" + injectedFiles + ", gigabytes="
				+ gigabytes + ", ram=" + ram + ", floatingIps=" + floatingIps
				+ ", instances=" + instances + ", volumes=" + volumes
				+ ", cores=" + cores + ", securityGroups=" + securityGroups
