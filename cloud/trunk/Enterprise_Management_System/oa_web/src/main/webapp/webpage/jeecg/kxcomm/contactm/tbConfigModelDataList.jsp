 	...
 	function add(rowIndex, rowData){
 		...
 		if(flag){
 				$('#tb tr:last').after("<tr  align='center'>"
 	 		 			...
 	 		 			+"<td width='2%' style='border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;'><input type='text' name='quantity' size='5' value='"+rowData.quantity+"' onblur='change1(this);'/></td>"
 	 		 			...
 	 		 			+"<td width='3%' style='border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;'><input type='text' name='discountrate' size='5' value='"+rowData.discountrate+"' onblur='change2(this);'/></td>"
