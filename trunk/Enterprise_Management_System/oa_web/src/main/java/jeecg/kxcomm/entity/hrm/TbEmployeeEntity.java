...
public class TbEmployeeEntity implements java.io.Serializable {
	...
	/**机构主键id*/
	private java.lang.String orgenJd;
	/**岗位主键id*/
	 ...
	 */
	@Column(name ="ORGEN_JD",nullable=true,length=50)
	public java.lang.String getOrgenJd(){
		return this.orgenJd;
	}
	 ...
	 */
	public void setOrgenJd(java.lang.String orgenJd){
		this.orgenJd = orgenJd;
	}
	/**
	 *方法: 取得java.lang.String
