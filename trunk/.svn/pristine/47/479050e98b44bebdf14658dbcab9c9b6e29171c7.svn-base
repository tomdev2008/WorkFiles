...
<table border="0" cellpadding="2" cellspacing="0" id="tbOrderDetail_table"  width="100%">
	<tr bgcolor="#E6E6E6">
				 <td align="left" bgcolor="#EEEEEE" width="10%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">康讯订单号</td>
				 <td align="left" bgcolor="#EEEEEE" width="20%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">项目名称</td>
				 <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">客户名称</td>
				 <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">最终客户</td>
				 <td align="left" bgcolor="#EEEEEE" width="5%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">负责人</td>
				 <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">付款方式</td>
				  <td align="left" bgcolor="#EEEEEE" width="5%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">名称</td>
				  <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">型号</td>
				  <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">单价</td>
				  <td align="left" bgcolor="#EEEEEE" width="4%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">数量</td>
				  <td align="left" bgcolor="#EEEEEE" width="10%" style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">金额</td>
	</tr>
