  ...
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        ...
        <img src="/jsp/common/images/checkcode.png" id="safecode" />
      </div>
    </div>
    <div id="center_middle_right"></div>
    <div id="center_submit">
      <div class="button"> <img src="/jsp/common/images/dl.gif" width="57" height="20" onclick="form_submit()" > </div>
      <div class="button"> <img src="/jsp/common/images/cz.gif" width="57" height="20" onclick="form_reset()"> </div>
    </div>
