...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tbOrderDetailCopyList" title="销售订单明细" actionUrl="tbOrderDetailController.do?datagrid"  idField="id" fit="true">
   ...
   <t:dgCol title="康讯订单号" field="tbOrder_kxOrderNo" query="true" width="60"></t:dgCol>
   ...
   <%--<t:dgCol title="总价" field="totalprice" width="50"></t:dgCol>--%>
   <t:dgCol title="操作" field="opt" width="50"></t:dgCol>
   <t:dgFunOpt funname="purchaseDetail(id)" title="采购明细"></t:dgFunOpt>
   <t:dgToolBar title="采购" icon="icon-add" url="tbPurchaseController.do?addorupdate" funname="update1"></t:dgToolBar>
   
  </t:datagrid>
  </div>
  <div region="east"  style="width:950px;overflow: hidden;" split="true" border="false">
		<div class="easyui-panel"  style="padding:1px;" title="采购订单" fit="true" border="false" id="purchasePanel">
