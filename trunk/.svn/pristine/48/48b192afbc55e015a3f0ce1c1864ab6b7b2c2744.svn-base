...
#login .logo {
 ...
 <body>
   ...
   <div class="inner">
    ...
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
      ...
      <div class="tip">
       <input class="userName" name="userName" type="text" id="userName" title="用户名" iscookie="true" value="test"  nullmsg="请输入用户名!"/>
      </div>
      <div class="tip">
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="http://www.kxcomm.com.cn/" title="康讯通讯">北京市康讯通讯设备有限公司</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)</span>
   </div>
  </div>
    <!-- Link JScript-->
