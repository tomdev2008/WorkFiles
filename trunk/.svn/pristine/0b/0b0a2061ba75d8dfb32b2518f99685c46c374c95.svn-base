...
public interface TbOrderServiceI extends CommonService{
	...
	public PageList getPageList(HqlQuery hqlQuery, boolean b,TbOrderEntity tbOrder, String kxOrderNo,String projectName,String contractNo,String client,String principal,String status,String totalPrice);
}
