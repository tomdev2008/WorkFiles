...
//提交表单前，获得所选择的复选框。
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tbPurchaseContractController.do?save" beforeSubmit="wantSelections();">
			...
			<td class="value">
				<input nullmsg="请填写采购合同编号" errormsg="contrac格式不对" class="inputxt" id="contractNo" name="contractNo" datatype="*"
			...
			<div  style="width: 600px;height: 300px;overflow-y:scroll;overflow-x:scroll;">
