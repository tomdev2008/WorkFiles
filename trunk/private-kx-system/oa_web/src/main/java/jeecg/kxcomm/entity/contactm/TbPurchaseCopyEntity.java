 ...
 * @Description: 采购订单
 * @author zhangdaihao
 * @date 2013-09-28 17:55:11
 * @version V1.0   
 *
 */
@Entity
@Table(name = "tb_purchase_copy", schema = "")
@SuppressWarnings("serial")
public class TbPurchaseCopyEntity implements java.io.Serializable {
	/**id*/
	private java.lang.String id;
	/**purchaseContractId*/
	private java.lang.String purchaseContractId;
	/**area*/
	private java.lang.String area;
	/**purchaseContractNo*/
	private java.lang.String purchaseContractNo;
	/**supplier*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  purchaseContractId
	 */
	@Column(name ="PURCHASE_CONTRACT_ID",nullable=true,length=85)
	public java.lang.String getPurchaseContractId(){
		return this.purchaseContractId;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  purchaseContractId
	 */
	public void setPurchaseContractId(java.lang.String purchaseContractId){
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  purchaseContractNo
	 */
	@Column(name ="PURCHASE_CONTRACT_NO",nullable=true,length=16)
	public java.lang.String getPurchaseContractNo(){
		return this.purchaseContractNo;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  purchaseContractNo
	 */
	public void setPurchaseContractNo(java.lang.String purchaseContractNo){
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  purchaser
	 */
	@Column(name ="PURCHASER",nullable=true,length=85)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  purchaser
	 */
