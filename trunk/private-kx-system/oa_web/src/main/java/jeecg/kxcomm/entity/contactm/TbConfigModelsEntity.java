...
public class TbConfigModelsEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="AFTER_DISCOUNT_NOW_PRICE",nullable=true,length=16)
	 ...
	 */
	@Column(name ="AFTER_DISCOUNT_PRICE",nullable=true,length=16)
	 ...
	 */
	@Column(name ="CATALOG_TOTAL_PRICE",nullable=true,length=16)
	 ...
	 */
	@Column(name ="CREATOR_ID",nullable=true,length=6)
