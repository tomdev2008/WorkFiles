...
<table border="0" cellpadding="2" cellspacing="0" id="tbOrderDetail_table" width="100%">
	<tr bgcolor="#E6E6E6">
				  <td align="left" bgcolor="#EEEEEE"  width="20%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">名称</td>
				  <td align="left" bgcolor="#EEEEEE"  width="20%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">型号</td>
				  <td align="left" bgcolor="#EEEEEE"  width="20%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">单价</td>
				  <td align="left" bgcolor="#EEEEEE"  width="20%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">数量</td>
				  <td align="left" bgcolor="#EEEEEE"  width="20%"  style="border-style: dotted;border-color: #ccc;border-width: 0 1px 1px 0;">金额</td>
	</tr>
