...
a:hover {
 ...
 <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
  <!-- 顶部-->
  <div region="north" border="false" title="康讯企业管理系统" style="BACKGROUND:#E6E6FA;height: 85px; padding: 1px; overflow: hidden;">
  ...
  <div region="south" border="false" style="height: 25px; overflow: hidden;">
    ...
    &copy; 版权所有
     <span class="tip"><a href="http://www.kxcomm.com.cn/" title="康讯通讯">北京市康讯通讯设备有限公司</a> (推荐谷歌浏览器，获得更快响应速度) </span>
   </div>
  </div>
