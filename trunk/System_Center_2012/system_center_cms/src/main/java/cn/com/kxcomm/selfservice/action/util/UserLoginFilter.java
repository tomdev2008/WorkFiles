...
public class UserLoginFilter implements javax.servlet.Filter {
	...
	/**
	 * 无需校验的action列表，以","分割〄1�7
	 */
	private String common_action_rights;

	/**
	 * 无需校验的page列表，以","分割〄1�7
	 */
...
//		t.start();
		InitDatabase initDatabase = InitDatabase.getSingleInstance();
		initDatabase.writeData();
	...
	/**
	 * 
	 * 方法用�1�7�和描述: 当用户登录后，判断用户访问的URl是否在公有权限列表中
	 * @param url
	 * @return true  or  false , if true:无需鉴权，放行访问�1�7�1�7
	 * @author chenhui 新增日期＄1�710-6-29
	 * @author 你的姓名 修改日期＄1�710-6-29
	 * @since zte_ipmi_bi
	 */
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		String url = request_uri.substring(ctxPath.length()); // 去除上下文路径，得到剩余部分的路径1�7
...
//					out.close();
			...
			log.error("过滤器异帄1�7",e);
		}
	}

	/**
	 * 
	 * 方法用�1�7�和描述: 从request中获取属性�1�7�1�7
	 * @param req 
	 * @param name request中的属�1�7�名
	 * @return -1:没有获取到，其他值：对应的属性�1�7�1�7
	 * @author libu 新增日期＄1�711-5-7
	 * @author 你的姓名 修改日期＄1�711-5-7
	 * @since zte_ipmi_bi
	 */
