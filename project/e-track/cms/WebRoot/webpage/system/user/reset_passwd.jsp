 ...
 <body>
  ...
  <div id="login">
   ...
   <div class="inner">
    ...
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController.do?login" check="userController.do?checkreset" method="post">
      <input name="userKey" type="hidden" id="userKey" value="CommonUserResetPasswd"/>
      <div class="tip">
       ...
       <div style="float: right; padding: 3px 0; margin-right: -12px;">
        <div>
         <ul class="uibutton-group">
          <li>
           <a class="uibutton normal" href="#" id="but_login">重置密码</a>
          </li>
          <li>
